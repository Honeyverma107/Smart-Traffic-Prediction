...
const ViolationsModule = ({ t, searchQuery, setSearchQuery, filterViolationType, setFilterViolationType, filterStatus, setFilterStatus, filteredChallans, setSelectedViolation, setShowChallanModal }) => (
