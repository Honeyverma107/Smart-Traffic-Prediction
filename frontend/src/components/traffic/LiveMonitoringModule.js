  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <div style={{ background: t.bgSurface, border: `1px solid ${t.border}`, borderRadius: '8px', padding: '16px', boxShadow: t.shadow }}>
          ...
          <div style={{ position: 'relative', width: '100%', aspectRatio: '16/9', borderRadius: '6px', overflow: 'hidden', background: '#080C14', border: `1px solid ${t.border}` }}>
            <video
              ...
              style={{ position: 'relative', zIndex: 1, width: '100%', height: '100%', objectFit: 'cover', display: videoError ? 'none' : 'block' }}
            >
              <source src="/ai_challan_violation.mp4" type="video/mp4" />
              <source src="/media/ai_challan_violation.mp4" type="video/mp4" />
              <source src={`${process.env.PUBLIC_URL || ''}/ai_challan_violation.mp4`} type="video/mp4" />
            </video>
            ...
            {videoError && (
              <div style={{ position: 'absolute', inset: 0, zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: t.bgElevated, color: t.textSecondary, gap: '8px', padding: '20px', textAlign: 'center' }}>
                ...
                <button type="button" onClick={() => { if (videoRef.current) { videoRef.current.load(); videoRef.current.play().catch(() => {}); } }} style={{ marginTop: '4px', padding: '5px 12px', borderRadius: '4px', background: t.primaryBg, border: `1px solid ${t.primaryBorder}`, color: t.primary, fontWeight: 700, fontSize: '0.74rem', cursor: 'pointer' }}>Retry Feed Connection</button>
              </div>
            )}
    ...
    <div style={{ background: t.bgSurface, border: `1px solid ${t.border}`, borderRadius: '8px', padding: '16px 20px', boxShadow: t.shadow }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '14px' }}>
        ...
        <button type="button" onClick={() => navigateToTab('violations')} style={{ background: 'none', border: 'none', color: t.primary, fontWeight: 700, fontSize: '0.76rem', cursor: 'pointer' }}>View All →</button>
      </div>
...
export default LiveMonitoringModule;
